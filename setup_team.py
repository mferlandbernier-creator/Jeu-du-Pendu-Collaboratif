...
def initialiser_projet():
	...
	print("   - git checkout -b feature-jeu Marie-Ève Ferland-Bernier")
	print("   - git checkout -b feature-affichage Jeremy Noivo")
	print("   - git checkout -b feature-choisir-mot Jean-Simon Cyr")
	print("   - git checkout -b eature-main Eva Bessette")
